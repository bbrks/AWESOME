...
\begin{tabular}{ |p {3cm} | p {10cm}| }
  \hline
  \multicolumn{2}{|c|}{\textbf{Student} \cellcolor{gray!25}} \\
  \hline
...
The client redefines the project requirements
 & Unlikely to happen, meetings will be held and requirements can be redrafted & \cellcolor{green!50} Low\\ \hline
 
Accidental deletion of file from repository
 & GitHub provides a robust mechanism for retrieving backups and versioning & \cellcolor{green!50} Low \\ \hline
...
\hline
1b & 19-06-2014 & Completed UI / Risk Analysis& KeironO \\
\hline
